            ...
            <div class="tab-content">
                <div class="tab-pane fade show active" id="companiesListPane" role="tabpanel" aria-labelledby="companiesListTab">
                    <div class="card" data-list>
                        <form action="{{route('update-categories', $certain_category->id)}}" method="post">
                            @method('POST')
                            @csrf
                            <div class="row">
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane fade show active" id="kaz" role="tabpanel">
                                                <div class="mb-4">
                                                    ...
                                                    <input value="{{$certain_category->name}}" type="text" class="form-control form-control-solid" name="name">
                                                </div>
                                                <div class="mb-4">
