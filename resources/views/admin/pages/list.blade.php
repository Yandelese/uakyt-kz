        ...
        <div class="row justify-content-center">
            <div class="header">
                <div class="header-body">
                    Все страницы <a href="{{route('create-pages')}}" class="btn btn-primary btn-sm" style="margin-left: 900px">Добавить </a>
                </div>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                            <div class="icon-admin" style="display: flex; gap: 10px;">
                                                <a href="{{route('edit-pages',$pages->id)}}">
                                                ...
                                                <a href="{{route('delete-pages',$pages->id)}}">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" height="24" width="24">
