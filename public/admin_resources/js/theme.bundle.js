(() => {
    var e, t = {
        250: () => {
            ...
            "use strict";
            var o = a(169);
            const n = document.querySelector("#popoverDemo"), r = document.querySelector("#offcanvasDemo"),
                l = document.querySelector("#topnav"), s = document.querySelector("#topbar"),
                c = document.querySelector("#sidebar"), i = document.querySelector("#sidebarSmall"),
                d = document.querySelector("#sidebarUser"), u = document.querySelector("#sidebarSmallUser"),
                p = document.querySelector("#sidebarSizeContainer"),
                h = document.querySelectorAll('input[name="navPosition"]'),
                b = document.querySelectorAll('[class^="container"]'), f = document.querySelector("#stylesheetLight"),
                m = document.querySelector("#stylesheetDark"), k = {
            ...
            !function () {
                if (n) {
                    const e = JSON.parse(k.showPopover) && "base" === k.sidebarSize, t = new o.J2(n, {
                        offset: [0, 16],
                        placement: "top",
            ...
            }(), "light" == (S = k.colorScheme) ? (f.disabled = !1, m.disabled = !0, S = "light") : "dark" == S && (f.disabled = !0, m.disabled = !1, S = "dark"), function (e) {
                if (l && s && c && i && d && u) if ("topnav" == e) {
                    g(s), g(c), g(i);
            ...
            }(k.navPosition), w = k.navColor, c && i && l && ("default" == w ? (c.classList.add("navbar-light"), i.classList.add("navbar-light"), l.classList.add("navbar-light")) : "inverted" == w ? (c.classList.add("navbar-dark"), i.classList.add("navbar-dark"), l.classList.add("navbar-dark")) : "vibrant" == w && (c.classList.add("navbar-dark", "navbar-vibrant"), i.classList.add("navbar-dark", "navbar-vibrant"), l.classList.add("navbar-dark", "navbar-vibrant"))), "base" == (L = k.sidebarSize) ? g(i) : "small" == L && g(c), r && function (e, t, a, o, n) {
            ...
            }(r, k.colorScheme, k.navPosition, k.navColor, k.sidebarSize), p && y(k.navPosition), document.body.style.display = "block", r && (r.addEventListener("submit", (function (e) {
            ...
            l && new r.Sortable(l, {
                draggable: ".form-elements-check",
                handle: ".form-elements-check-label",
                ...
                const t = {
                    ...e.dataset.choices ? JSON.parse(e.dataset.choices) : {}, ...{
                        classNames: {
                            ...
                            input: "form-elements-control",
                            inputCloned: "form-elements-control-sm",
            ...
            var p = a(802), h = a.n(p), b = a(344), f = a.n(b), m = a(157), k = a.n(m);
            const v = document.querySelectorAll(".highlight");
            h().registerLanguage("xml", k()), h().registerLanguage("javascript", f()), v.forEach((e => {
                h().highlightBlock(e)
            })), window.hljs = h();
            var y = a(382), g = a.n(y);
            const S = document.querySelectorAll("[data-inputmask]");
            g()({rightAlign: !1}).mask(S), window.Inputmask = g();
            const w = document.querySelectorAll(".kanban-category"), L = document.querySelectorAll(".kanban-add-link"),
                C = document.querySelectorAll(".kanban-add-form-elements");

            function E(e) {
                const t = e.closest(".kanban-add"), a = t.querySelector(".card"),
                    o = t.querySelector(".kanban-add-link"), n = t.querySelector(".kanban-add-form-elements");
            ...
            w && new r.Sortable(w, {draggable: ".kanban-item", mirror: {constrainDimensions: !0}}), L.forEach((e => {
            ...
            !function () {
                ...
                void 0 !== O() && e && [].forEach.call(e, (function (e) {
                    !function (e) {
                        const t = e.querySelector(".list-alert"), o = e.querySelector(".list-alert-count"),
                            n = e.querySelector(".list-alert .btn-close"), r = e.querySelectorAll(".list-checkbox"),
                            l = e.querySelector(".list-checkbox-all"), s = e.querySelectorAll(".list-pagination"),
            ...
            const J = {
                ...
                }, N = "Cerebri Sans", P = document.querySelectorAll('[data-toggle="chart"]'),
                z = document.querySelectorAll('[data-toggle="legend"]');

            function B(e) {
                const {chart: t, tooltip: a} = e, o = function (e) {
                ...
                if (a.body) {
                    const e = a.title || [], n = a.body.map((e => e.lines)), r = document.createElement("div");
                    e.forEach((e => {
                    ...
                    n.forEach(((e, o) => {
                        const r = a.labelColors[o], s = document.createElement("span");
            ...
            I.kL.defaults.responsive = !0, I.kL.defaults.maintainAspectRatio = !1, I.kL.defaults.color = T("--bs-chart-default-color"), I.kL.defaults.font.family = N, I.kL.defaults.font.size = 13, I.kL.defaults.layout.padding = 0, I.kL.defaults.plugins.legend.display = !1, I.kL.defaults.elements.point.radius = 0, I.kL.defaults.elements.point.backgroundColor = J.primary[700], I.kL.defaults.elements.line.tension = .4, I.kL.defaults.elements.line.borderWidth = 3, I.kL.defaults.elements.line.borderColor = J.primary[700], I.kL.defaults.elements.line.backgroundColor = J.transparent, I.kL.defaults.elements.line.borderCapStyle = "rounded", I.kL.defaults.elements.bar.backgroundColor = J.primary[700], I.kL.defaults.elements.bar.borderWidth = 0, I.kL.defaults.elements.bar.borderRadius = 10, I.kL.defaults.elements.bar.borderSkipped = !1, I.kL.defaults.datasets.bar.maxBarThickness = 10, I.kL.defaults.elements.arc.backgroundColor = J.primary[700], I.kL.defaults.elements.arc.borderColor = T("--bs-chart-arc-border-color"), I.kL.defaults.elements.arc.borderWidth = 4, I.kL.defaults.elements.arc.hoverBorderColor = T("--bs-chart-arc-hover-border-color"), I.kL.defaults.plugins.tooltip.enabled = !1, I.kL.defaults.plugins.tooltip.mode = "index", I.kL.defaults.plugins.tooltip.intersect = !1, I.kL.defaults.plugins.tooltip.external = B, I.kL.defaults.plugins.tooltip.callbacks.label = M, I.kL.defaults.datasets.doughnut.cutout = "83%", I.kL.overrides.doughnut.plugins.tooltip.callbacks.title = function (e) {
                ...
                e.addEventListener(t, (function () {
                    !function (e) {
                        const t = e.dataset.target, a = e.dataset.action, o = parseInt(e.dataset.dataset),
                            n = document.querySelector(t), r = I.kL.getChart(n);
                        if ("toggle" === a) {
                            const e = r.data.datasets, t = e.filter((function (e) {
                                return !e.hidden
                            }))[0];
                        ...
                        if ("add" === a) {
                            const e = r.data.datasets[o], t = e.hidden;
                            e.hidden = !t
                        }
                        r.update()
                    }(e)
